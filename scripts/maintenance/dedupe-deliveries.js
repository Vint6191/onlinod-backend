 ...
 *
 * Запуск:
 *   node scripts/maintenance/dedupe-deliveries.js          -> DRY-RUN (только покажет, ничего не удалит)
 *   node scripts/maintenance/dedupe-deliveries.js --apply  -> реально удалит дубли
 *
 */
