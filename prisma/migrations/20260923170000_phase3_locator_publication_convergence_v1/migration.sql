-- A37-R3. Serialize locator identity creation AND child-head reconciliation.
-- ON CONFLICT without a target arbitrates both id and natural unique indexes.
-- An uncommitted placeholder establishes the row lock before reading child truth;
