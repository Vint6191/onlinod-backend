...
// Domain route registration is split into small files so this router no longer
// carries every automation endpoint in one 3k-line blob. Delivery-heavy routes
// below stay here until their Prisma helpers are isolated in the next pass.
...
registerHiddenOnlineRoutes(router, {
  ...automationRouteDeps,
  parseDate,
  dateIso,
  deliveryMeta,
