...
test("INT5.7A-3 Campaign current collector advances beyond v8 while retaining v8 ingest compatibility", () => {
  ...
  assert.match(ledger, /new Set\(\["campaigns-v5", "campaigns-v6", "campaigns-v7", "campaigns-v8", "campaigns-v9", "campaigns-v10", "campaigns-v11", "campaigns-v12", CAMPAIGN_COLLECTOR_VERSION\]\)/);
