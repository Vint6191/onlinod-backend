...
test("analytics ledger enums are explicit and stable", () => {
  assert.deepEqual(ANALYTICS_DATA_TYPES, ["EARNINGS", "NOTIFICATIONS", "NOTIFICATION_PURCHASES", "NOTIFICATION_TIPS", "NOTIFICATION_SUBSCRIPTIONS", "NOTIFICATION_LIKES", "NOTIFICATION_COMMENTS", "CAMPAIGNS", "SALES", "PAID_SUBSCRIPTIONS", "MESSAGES_DAILY"]);
