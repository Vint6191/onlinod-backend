...
function normalizeAuditRow(row, index) {
  ...
  return {
    ...
    fanUsernameAtEvent: clean(row?.fanUsernameAtEvent, 200),
    fanDisplayNameAtEvent: clean(row?.fanDisplayNameAtEvent, 500),
    fanAvatarUrlAtEvent: clean(row?.fanAvatarUrlAtEvent, 1200),
...
function itemForClient(row) {
  return {
    ...
    fanUsernameAtEvent: row.fanUsernameAtEvent,
    fanDisplayNameAtEvent: row.fanDisplayNameAtEvent,
    fanAvatarUrlAtEvent: row.fanAvatarUrlAtEvent,
    postId: row.postId,
