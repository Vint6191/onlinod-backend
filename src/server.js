...
const ofRequestGateRoutes = require("./routes/of-request-gate");
...
const teamScheduleRoutes = require("./routes/team-schedule");
...
const vaultDirectoryRoutes = require("./routes/vault-directory");
const mediaLibraryRoutes = require("./routes/media-library");
...
const legacyFanListsRoutes = createLegacyGoneRouter("server_fan_lists", "current MASS local audience pipeline");
const legacySegmentsRoutes = createLegacyGoneRouter("server_segments", "current MASS local audience pipeline");
const legacyCampaignsRoutes = createLegacyGoneRouter("server_campaigns", "current MASS CreatorApiRuntime queue");
const legacyVaultSalesRoutes = createLegacyGoneRouter("server_vault_sales", "current Vault/Media Library + local dialog history");
const legacyDiagnosticsRoutes = createLegacyGoneRouter("server_store_diagnostics", "admin-auth diagnostics");
const legacyAuditRoutes = createLegacyGoneRouter("generic_agency_audit", "/api/team audit surface");
